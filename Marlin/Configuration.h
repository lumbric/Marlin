...
#define STRING_CONFIG_H_AUTHOR "(www.HKBay.com, Mini Kossel)" // Who made the changes.
...
// #define CUSTOM_MENDEL_NAME "www.HKBay.com Kossel"
...
#define DELTA_PRINTABLE_RADIUS 95.0  //MR: Changed from 80.0
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -6.08  //MR: CHANGE Z-PROBE OFFSET HERE! The higher Z, the closer the head is to the printbed
...
//CALIB
#define MANUAL_Z_HOME_POS 265.2  // CHANGE HEIGHT OF PRINTER HERE! For delta: Distance between nozzle and print surface after homing.
