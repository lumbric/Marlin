...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -5.70  //MR: CHANGE Z-PROBE OFFSET HERE! The higher Z, the closer the head is to the printbed
...
//CALIB
#define MANUAL_Z_HOME_POS 265.6  // CHANGE HEIGHT OF PRINTER HERE! For delta: Distance between nozzle and print surface after homing.
