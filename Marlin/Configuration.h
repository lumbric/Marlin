...
#define STRING_SPLASH_LINE2 "..and good printing!"  // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "rubinstein"
...
// This is a lot to be able to retract/extrude one bowden length
...
#define DELTA
  ...
  // Petreg: note: this has been set to 95.0 in original config.
  ...
  #define DELTA_HEIGHT 264.3 // get this value from auto calibrate
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -6.35  // Z offset: -below +above  [the nozzle]
...
#define Z_PROBE_ALLEN_KEY
  ...
  #define Z_PROBE_ALLEN_KEY_DEPLOY_1_Y 80.0
  #define Z_PROBE_ALLEN_KEY_DEPLOY_1_Z 100.0
  #define Z_PROBE_ALLEN_KEY_DEPLOY_1_FEEDRATE XY_PROBE_SPEED

  #define Z_PROBE_ALLEN_KEY_DEPLOY_2_X 8.0
  #define Z_PROBE_ALLEN_KEY_DEPLOY_2_Y 80.0
  ...
  #define Z_PROBE_ALLEN_KEY_STOW_1_X -33.0
  #define Z_PROBE_ALLEN_KEY_STOW_1_Y 85.5
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { -36,    -96.5,  13.3}
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT NOZZLE_PARK_POINT
  #define NOZZLE_CLEAN_END_POINT   { -61.35, -89.62, 13.3}
